...
Write-Host "启动 12306 聚合服务" -ForegroundColor Cyan
Write-Host "==================================" -ForegroundColor Cyan
Write-Host ""
...
# 检查 JAR 文件是否存在
$jarPath = "services\aggregation-service\target\index12306-aggregation-service.jar"
...
# 启动服务
Write-Host "`n正在启动聚合服务..." -ForegroundColor Yellow
Write-Host "端口: 9005" -ForegroundColor Gray
...
# 启动 JAR
java -Xms512m -Xmx2g -jar $jarPath
